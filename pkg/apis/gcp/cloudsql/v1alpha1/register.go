...
// +k8s:conversion-gen=github.com/crossplaneio/crossplane/pkg/gcp/apis/gcp/cloudsql
...
const (
	Group                  = "cloudsql.gcp.crossplane.io"
	Version                = "v1alpha1"
	APIVersion             = Group + "/" + Version
	InstanceKind           = "instance"
	InstanceKindAPIVersion = InstanceKind + "." + APIVersion
)
